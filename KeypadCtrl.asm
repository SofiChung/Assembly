...
KCODE0   DC.B $06, $5B, $4F, $77
KCODE1   DC.B $66, $6D, $7D, $7C
KCODE2   DC.B $07, $7F, $6F, $39
KCODE3   DC.B $79, $3F, $71, $5E
...
MATCH:                ;
   LDAA  0,X          ;LOAD 7 SEGMENT DISPLAY CODE FROM ROW ARRAY
   ;STAA  LED          ;PUT 7 SEGMENT DISPLAY CODE TO PORTB
   STAA  PORTB        ;PUT 7 SEGMENT DISPLAY CODE TO PORTB
   LDAA  #$07
   STAA  PTP
